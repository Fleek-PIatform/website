...
To remove a project, navigate to the project dashboard and select the 'Settings' icon. You will be asked to confirm the removal of all associated resources within the project. Ensure you check the box to the right to acknowledge this action before proceeding for:
