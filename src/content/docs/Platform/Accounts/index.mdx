...
2. Under 'Managed Connections,' click on the three-dotted menu of the email address you wish to update.
...
1. Going to the 'Account Settings' page and navigating to the 'Log In Connections' section, specifically the 'Manage Connections' section within it.
2. Clicking on the three-dotted menu on the wallet you wish to unlink.
...
Ensure that you diligently copy and store your PAT in a safe and secure manner. It's crucial to understand that the value of this token will be revealed only once, and if lost, might not be retrievable. Taking precautionary measures now can prevent potential complications or security breaches in the future.
