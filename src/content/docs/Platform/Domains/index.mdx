...
Fleek allows you to set up domains for your sites that enable you to provide a better experience to your users.
...
To set up your ENS using the automatic integration you need to have the wallet that owns the ENS linked to the Fleek application.
