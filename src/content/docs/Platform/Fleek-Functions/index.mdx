...
Put simply, you can call Fleek Functions from the front-end of your application just as you would invoke any code that returns a response from a server.

- You can implement server-side rendering (SSR) for your entire application
- You can call APIs to retrieve or populate data on the user interface
- You can make routing requests.
- etc.
