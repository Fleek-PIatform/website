...
Functions can now be accessed via the Fleek Platform [CLI](/docs/cli) and [Fleek Platform app](/docs/platform/fleek-functions-ui). Discover how to create your initial Fleek Function by reading any of these guides:

- [Create and deploy Fleek Functions from Fleek CLI](/docs/cli/functions)
- [Create and deploy Fleek Functions from Fleek platform UI](/docs/platform/fleek-functions-ui#create-and-deploy-a-fleek-function)
