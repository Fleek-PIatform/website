...
<DocsCards
  ...
  features={[
    ...
    },
    {
      title: 'Templates',
      description:
        'Templates are pre-designed solutions for common frameworks.',
  ...
  features={[
    {
      ...
      icon: '/svg/integrate-icon.svg',
      url: '/blog',
    },
    {
      title: 'Community',
      description:
        'Join the community to connect with peers and share knowledge.',
      icon: '/svg/storage-icon.svg',
      url: 'TODO_DISCORD_URL',
    },
    {
      title: 'Repositories',
      description:
        "Discover Fleek's repositories for code examples and tools to enhance your projects.",
      icon: '/svg/scale-icon.svg',
      url: 'TODO_GITHUB_URL',
    },
  ]}
/>
