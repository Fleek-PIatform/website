  ...
  <Container>
    <PageSection>
      <GridLayout className="py-64 lg:py-80">
        <div className="col-span-16 text-center text-ui-light-grey">
          <TextGlowHoverEffect style="h3">
            <Text as="h3" style="h3" className="mb-30 text-ui-white">
              Seamlessly Pay With Card or Crypto
            </Text>
          </TextGlowHoverEffect>
          <Text as="p" style="xl" className="mb-48">
            Automatically refill your account by linking a card or a crypto
            wallet. Pay in your favourite cryptocurrency or token.
          </Text>
