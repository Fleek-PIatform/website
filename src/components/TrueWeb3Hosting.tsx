  ...
  <Container>
    <PageSection>
      <GridLayout className="py-50">
        <div className="col-span-16 flex flex-col gap-48 xl:col-span-10 xl:col-start-4">
          <div className="flex flex-col gap-24 text-center">
            ...
            <Text className="text-ui-light-grey">
              We don’t just take speed seriously, but also web3. We combine
              multiple web3 technologies/protocols to help create a true
              decentralized modern web stack and services.
            </Text>
          </div>
          <div className="grid-dense-cols grid gap-16 md:grid-cols-2 lg:grid-cols-3">
