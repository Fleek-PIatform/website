...
const Footer = () => {
  return (
    <footer className="bg-gray-dark-1 px-20 pb-40 pt-80 text-gray-dark-11 lg:px-0 overflow-hidden">
      <Container>
        <GridLayout>
          <div className="col-span-16 mb-24 flex flex-col md:col-span-6 md:mb-0">
            <img
          ...
          <div className="col-span-16 md:col-span-10">
            <div className="sm:grid grid-cols-6 gap-x-16 gap-y-24 lg:grid-cols-12">
              <div className="mb-20 col-span-3 flex flex-col gap-12">
