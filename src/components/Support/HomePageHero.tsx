      ...
      <div className="flex items-center justify-center">
        <div className="w-full  py-[12rem]">
          <div className="mb-[3rem] text-center">
            <h1 className="text-[3.4rem] font-semibold">
              How can we help you?
            </h1>
          </div>

          <div className="mx-auto mb-[4rem]  mt-[1rem] w-[40%] rounded-[8px] border-white/30 bg-[#FFFFFF]/10 px-[1.5rem] py-[1.25rem] focus-within:border-[.1px] focus-within:bg-[#FFFFFF]/25 hover:border-[.1px] hover:bg-[#FFFFFF]/25">
