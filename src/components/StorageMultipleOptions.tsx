      ...
      <PageSection>
        <GridLayout className="py-25">
          <div className="col-start-2 col-span-12 mb-16 relative h-[200px] md:h-[305px] lg:col-span-8 lg:col-start-9 lg:h-[375px]">
            <FlyingToken icon={ArweaveTokenImage} alt="Arweave Token" className="top-0 right-1/4" />
            <FlyingToken icon={FilecoinTokenImage} alt="Filecoin Token" className="top-1/3 right-1/2" />
            <FlyingToken icon={IPFSTokenImage} alt="IPFS Token" className="top-1/2 right-0" />
          </div>
